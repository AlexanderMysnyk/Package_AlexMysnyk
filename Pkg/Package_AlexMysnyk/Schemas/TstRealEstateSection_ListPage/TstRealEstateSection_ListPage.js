define("TstRealEstateSection_ListPage", /**SCHEMA_DEPS*/[]/**SCHEMA_DEPS*/, function/**SCHEMA_ARGS*/()/**SCHEMA_ARGS*/ {
	return {
					...
					"columns": [
						{
							...
							"code": "PDS_TstName",
							"caption": "#ResourceString(PDS_TstName)#",
							"dataValueType": 1
						},
						{
